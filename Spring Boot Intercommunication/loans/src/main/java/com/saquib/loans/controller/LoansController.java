...
public class LoansController {
    ...
    @Operation(
            ...
            description = "Get Java version details that is installed in to laons microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
